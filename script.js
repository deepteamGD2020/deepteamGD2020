...
// ================================
  ...
  var str = "<p>dear reader</p> <br> <p>our private spaces have become the centers of our public lives" +spacing+ "our common place has dispersed"+spacing+"and we found ourselves in our bedrooms"+spacing+"making projects related to social"+spacing+"political and economic issues"+spacing+"since then"+spacing+"we sought to re-enact a shared ground"+spacing+"and eventually"+spacing+"have patched our fragmented times into this very shared moment"+spacing+"to be experienced together on our own time </p> <br> <p> the works displayed on this platform have been materialized in a real-time physical encounter at our graduation festival"+spacing+"during which this platform will host a screening of complete works</p> <br> <p>although the graduation show this year is limited in terms of accessibility and time"+spacing+"we hope this platform will allow our audience to experience our work further on their own time</p><br><p>take care" +spacing+ "see you at the show</p><br><br><p>(type design" +spacing+ "chalga by nedislav kamburov" +spacing+ "sambo by edward dżułaj)</p><br><br>",
      i = 0,
      isTag,
      text;
